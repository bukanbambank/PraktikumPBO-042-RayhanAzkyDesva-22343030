...
//             CHECK IF THE FIELDS ARE EMPTY
            if (availableB_busID.getText().isEmpty()
                ...
                alert.setContentText("Silahkan isi semua kolom yang kosong");
                alert.showAndWait();
...
//                CHECK IF THE BUS ID IS ALREADY EXIST
                ...
                if (result.next()) {
                    ...
                    alert.setTitle("Error Message");
                    alert.setHeaderText(null);
                    alert.setContentText("ID Bus: " + availableB_busID.getText() + " Sudah terpakai");
                    alert.showAndWait();
                    ...
                    alert.setHeaderText(null);
                    alert.setContentText("Berhasil menambahkan!");
                    alert.showAndWait();
    ...
    public void availableBusUpdate() {
        ...
        try {
            ...
            if (availableB_busID.getText().isEmpty()
                ...
                alert.setHeaderText(null);
                alert.setContentText("Apakah anda yakin ingin memperbarui ID BUS: " + availableB_busID.getText() + "?");
    ...
    public void availableBusDelete(){
        ...
        try{
            ...
            if (availableB_busID.getText().isEmpty()
                ...
                alert.setTitle("Confirmation Message");
                alert.setHeaderText(null);
                alert.setContentText("Apakah Anda yakin menghapus ID BUS: " + availableB_busID.getText() + "?");
...
//    NOW LETS CREATE TABLE FOR customer
    ...
    public void bookingTicketSelect(){
        ...
        if(firstName == null || lastName == null 
            ...
            alert.setTitle("Information Message");
            alert.setHeaderText(null);
            alert.setContentText("Berhasil dipilih!");
            alert.showAndWait();
...
//            CHECK IF EMPTY
            if(bookingTicket_sci_firstName.getText().isEmpty()
                ...
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Silahkan pilih informasi terlebih dahulu");
                alert.showAndWait();
    ...
    public void bookingTicketReceipt(){
        ...
        try{
            ...
            if(totalP > 0){
                ...
                JasperDesign jDesign = JRXmlLoader.load("C:\\Users\\hrahm\\OneDrive\\Documents\\Perkuliahan\\Azky\\busTicketBookingManagementSystem\\src\\busticketbookingmanagementsystem\\report.jrxml");
                ...
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Tidak Valid :3");
                alert.showAndWait();
...
//                LOGIN FORM 
    ...
    public void defaultBtn() {
        dashboard_Btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #1f4788, #003366)");
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == dashboard_Btn) {
            ...
            availableB_Btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #1f4788, #003366)");
...
//            TO UPDATE THE FORM ONCE YOU CLICK THE AVAIALABLE BUSES BUTTON 
            ...
            bookingTicket_Btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #1f4788, #003366)");
            availableB_Btn.setStyle("-fx-background-color:transparent");
            dashboard_Btn.setStyle("-fx-background-color:transparent");
            customers_btn.setStyle("-fx-background-color:transparent");
            ...
            customers_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #1f4788, #003366)");
            availableB_Btn.setStyle("-fx-background-color:transparent");
            bookingTicket_Btn.setStyle("-fx-background-color:transparent");
            dashboard_Btn.setStyle("-fx-background-color:transparent");
